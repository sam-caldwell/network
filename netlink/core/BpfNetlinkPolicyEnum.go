...
// BpfNetlinkPolicyEnum - bpf_nl_policy - defines BPF policy.
type BpfNetlinkPolicyEnum uint8
...
const (
	...
	LwtBpfUnspec BpfNetlinkPolicyEnum = 0
	...
	// lightweight tunnel.
	LwtBpfIn BpfNetlinkPolicyEnum = 1
	...
	LwtBpfOut BpfNetlinkPolicyEnum = 2
	...
	LwtBpfXmit BpfNetlinkPolicyEnum = 3
	...
	LwtBpfXmitHeadroom BpfNetlinkPolicyEnum = 4
	...
	LwtBpfMax BpfNetlinkPolicyEnum = iota - 1
)
