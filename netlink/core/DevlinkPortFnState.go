...
// DevlinkPortFnState - devlink_port_fn_state
//
...
const (
	...
	DevlinkPortFnStateInactive DevlinkPortFnState = 0
	...
	DevlinkPortFnStateActive DevlinkPortFnState = 1
)
