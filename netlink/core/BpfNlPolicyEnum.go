...
// BpfNlPolicyEnum - bpf_nl_policy - defines BPF policy.
type BpfNlPolicyEnum uint8
...
const (
	...
	LwtBpfUnspec BpfNlPolicyEnum = 0
	...
	LwtBpfXmitHeadroom BpfNlPolicyEnum = 4
	...
	LwtBpfMax BpfNlPolicyEnum = iota - 1
)
