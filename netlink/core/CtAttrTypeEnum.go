...
// CtAttrTypeEnum - ctattr_type -  constant in the Linux Netfilter framework that defines the type of connection tracking
...
const (
	...
	CtaTupleReply CtAttrTypeEnum = 2
	...
	CtaNat CtAttrTypeEnum = CtaNatSrc
	...
	CtaCountersOrig CtAttrTypeEnum = 9
	...
	CtaCountersReply CtAttrTypeEnum = 10
	...
	CtaTupleMaster CtAttrTypeEnum = 14
	...
	CtaSeqAdjOrig CtAttrTypeEnum = 15
	...
	// system.
	CtaNatSeqAdjOrig CtAttrTypeEnum = CtaSeqAdjOrig
	...
	CtaSeqAdjReply CtAttrTypeEnum = 16
	...
	CtaNatSeqAdjReply CtAttrTypeEnum = CtaSeqAdjReply
	...
	CtaTimestamp CtAttrTypeEnum = 20
	...
	CtaStatusMask CtAttrTypeEnum = 26
	...
	CtaMax CtAttrTypeEnum = CtaStatusMask
)
