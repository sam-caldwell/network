...
// GenericRoutingEncapsulationFlags - Enumeration for GRE (Generic Routing Encapsulation) flags and fields
//
...
type GenericRoutingEncapsulationFlags uint16
...
const (
	...
	//
	// https://github.com/torvalds/linux/blob/master/include/uapi/linux/if_tunnel.h
	GreCsum GenericRoutingEncapsulationFlags = 0x8000
	...
	//
	// https://github.com/torvalds/linux/blob/master/include/uapi/linux/if_tunnel.h
	GreRouting GenericRoutingEncapsulationFlags = 0x4000
	...
	//
	// https://github.com/torvalds/linux/blob/master/include/uapi/linux/if_tunnel.h
	GreKey GenericRoutingEncapsulationFlags = 0x2000
	...
	//
	// https://github.com/torvalds/linux/blob/master/include/uapi/linux/if_tunnel.h
	GreSeq GenericRoutingEncapsulationFlags = 0x1000
	...
	//
	// https://github.com/torvalds/linux/blob/master/include/uapi/linux/if_tunnel.h
	GreStrict GenericRoutingEncapsulationFlags = 0x0800
	...
	//
	// https://github.com/torvalds/linux/blob/master/include/uapi/linux/if_tunnel.h
	GreRec GenericRoutingEncapsulationFlags = 0x0700
	...
	//
	// https://github.com/torvalds/linux/blob/master/include/uapi/linux/if_tunnel.h
	GreAck GenericRoutingEncapsulationFlags = 0x0080
	...
	//
	// https://github.com/torvalds/linux/blob/master/include/uapi/linux/if_tunnel.h
	GreFlags GenericRoutingEncapsulationFlags = 0x00F8
	...
	//
	// https://github.com/torvalds/linux/blob/master/include/uapi/linux/if_tunnel.h
	GreVersion GenericRoutingEncapsulationFlags = 0x0007
)
