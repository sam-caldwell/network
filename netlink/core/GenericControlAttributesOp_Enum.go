...
// GenericControlAttributesOp - Enumeration for Generic Netlink Control Operation Attributes
//
...
type GenericControlAttributesOp uint8
...
const (
	...
	//
	// See https://docs.kernel.org/networking/gtp.html
	GenericNetlinkControlAttributeOpUnspec GenericControlAttributesOp = 0
	...
	//
	// See https://docs.kernel.org/networking/gtp.html
	GenericNetlinkControlAttributeOpId GenericControlAttributesOp = 1
	...
	//
	// See https://docs.kernel.org/networking/gtp.html
	GenericNetlinkControlAttributeOpFlags GenericControlAttributesOp = 2
)
