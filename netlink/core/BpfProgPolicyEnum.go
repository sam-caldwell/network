...
// BpfProgPolicyEnum - bpf_prog_policy - represents the BPF program policies associated with Lightweight Tunnels (LWT).
...
const (
	...
	LwtBpfProgUnspec BpfProgPolicyEnum = 0
	...
	LwtBpfProgFd BpfProgPolicyEnum = 1
	...
	LwtBpfProgName BpfProgPolicyEnum = 2
	...
	// this enumeration.
	LwtBpfProgMax BpfProgPolicyEnum = iota - 1
)
