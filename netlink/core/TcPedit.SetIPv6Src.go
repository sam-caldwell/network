...
// SetIPv6Src sets the IPv6 source address for the pedit action.
// This function modifies the IPv6 source address by splitting the 16-byte address into 4 parts,
...
// Parameters:
//
//	ip6 - The IPv6 source address to set (net.IP).
func (p *TcPedit) SetIPv6Src(ip6 net.IP) {
	...
	// Set the offset to 8, indicating the position in the IPv6 header.
	tKey.Off = 8
